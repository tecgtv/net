...
function renderCatalog(){
 ...
 const recentType=(currentFilter==="series")?"series":"movie";
 const recentEnabled=((currentFilter==="all" && currentCategory==="all") || (currentFilter==="series" && currentCategory==="all")) && !searchText;
 const recent=recentEnabled?getRecentlyWatched(recentType):[];
